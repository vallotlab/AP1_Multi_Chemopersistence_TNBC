...
QCs_param_list = list(
  HBCx172_Capecitabin = c(2000,100000,2000,9000,25), 
  ...
  HBCx221_Capecitabin = c(2000,100000,2000,9000,25),  
  HBCx221_chemonaive = c(2000,100000,2000,9000,25), 
  HBCx39_Capecitabin = c(2000,100000,2000,9000,25),  
  HBCx39_chemonaive = c(2000,100000,2000,9000,25),  
  HBCx95_Capecitabin = c(2000,100000,2000,9000,25),  
